...
/>
            ...
            <body className="clean-body" style={{margin: 0, padding: 0, WebkitTextSizeAdjust: '100%'}}>
              <table bgcolor="#ffe300" cellPadding={0} cellSpacing={0} className="nl-container" role="presentation" style={{tableLayout: 'fixed', verticalAlign: 'top', minWidth: 320, margin: '0 auto', borderSpacing: 0, borderCollapse: 'collapse', msoTableLspace: '0pt', msoTableRspace: '0pt', backgroundColor: '#ff0000',  backgroundImage:
            'url("https://images.ctfassets.net/d3a4e93836in/1kdZ2WvHYl9jF2zRer42LU/9f247405542b9f0e9b835382084eb20c/Desktop_-_6.png")',
          backgroundPosition: "center",
          backgroundRepeat: "no-repeat",
          backgroundSize: "cover", width: '100%'}} valign="top" width="100%">
                <tbody>
